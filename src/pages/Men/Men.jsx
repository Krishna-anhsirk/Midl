  ...
  return (
    <Layout tab="mens">
      <Container>
        ...
        <Subtitle>
          Discover premium clothing saved from destruction. Each piece tells a
          story of sustainability and style.
        </Subtitle>
        <Grid>
          {products.map((product) => (
            <ProductCard key={product.id}>
              <Link to={`/singleProduct/${8 + product.id}`}>
                <ImageContainer>
      ...
      <MoreInfo>More pieces coming....</MoreInfo>
    </Layout>
  );
};
